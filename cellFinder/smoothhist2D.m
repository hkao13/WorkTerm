...
%
%   SMOOTHHIST2D(X,LAMBDA,NBINS,[],'contour') plots a contour map of the
%   data in X. SMOOTHHIST2D ignores the CUTOFF input in this case, and
%   the contour plot does not include outliers. 
%   [Added by Henry Kao 04/08/14]
%
